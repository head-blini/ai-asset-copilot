...
BUD-01의 순수 계산·가상 입력·정상/급여 지연/목표 미정 및 회귀 시나리오 보고는 별도 `feat/budget-monthly-foundation` 후보에서 검토 중이다. 결과는 승인·이체·주문이나 BUD-02/03 구현이 아니다. 이 후보의 테스트·CI·리뷰·병합 상태는 [STATUS](STATUS.md)에서 추적하고, 기존 완료 조건은 유지한다.
