...
- P4-06/07 PR #7 first submitted head `beed16bbe19fee88911139073b63833fe01bd641` targeting PR #2 head `e49be74`: GitHub Actions run `36252548682` succeeded on generated merge checkout `18b584320ad6cbc74cab320a38cd9f3eae2c8911`, Ubuntu Python 3.11.16 / pytest 9.1.1, **277 passed**, pip check clean. This is CI evidence for that exact head only; a later documentation-only head needs its own check.
